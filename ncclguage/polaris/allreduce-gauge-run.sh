...
export NCCL_SRC_LOCATION=/home/ldai8/ccl/NCCL_profile

# Create a temp directory in your home or scratch
mkdir -p ${GAUGE_OUT_DIRE}/tmp

# Then override TMPDIR to point there
export TMPDIR=${GAUGE_OUT_DIRE}/tmp
